...
import { faBell, faBookBookmark, faEllipsisH, faEnvelope, faFeatherAlt, faHashtag, faHome, faUser, faUserFriends } from '@fortawesome/free-solid-svg-icons'
...
export function Sidebar (){
    ...
    return (
        <div className="w-20 xl:w-64 sticky top-0 px-2 h-screen">
            <FontAwesomeIcon icon={faTwitter} className='text-blue-400 text text-3xl m-4'/>
            ...
            <FontAwesomeIcon icon={faFeatherAlt} className='text-blue-400 text text-3xl m-4 inline xl:hidden'/>
